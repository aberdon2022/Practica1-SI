...
estadisticas_empleado = df[df['tipo_incidencia'] == 'Fraude'].groupby('empleado').agg(fraude_count=('ticket_id', 'count')).agg(['median', 'mean', 'var', 'min', 'max']).reset_index()
estadisticas_nivel = df[df['tipo_incidencia'] == 'Fraude'].groupby('nivel_empleado').agg(fraude_count=('ticket_id', 'count')).agg(['median', 'mean', 'var', 'min', 'max']).reset_index()
estadisticas_cliente = df[df['tipo_incidencia'] == 'Fraude'].groupby('cliente').agg(fraude_count=('ticket_id', 'count')).agg(['median', 'mean', 'var', 'min', 'max']).reset_index()
estadisticas_dia = df[df['tipo_incidencia'] == 'Fraude'].groupby('dia').agg(fraude_count=('ticket_id', 'count')).agg(['median', 'mean', 'var', 'min', 'max']).reset_index()
